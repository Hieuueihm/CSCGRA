module ctx_decoder #(
    ...
    assign pe_op      = (pe_addr_fmt || pe_imm_fmt) ? {ctx[3], ctx[2], ctx[15:13]} : 5'd0;
    ...
    assign reduce_op     = reduce_fmt ? ctx[27:24] : 4'd0;
