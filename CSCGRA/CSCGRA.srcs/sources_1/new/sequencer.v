module sequencer #(
    ...
    input  wire [15:0]          cg_maxiter,
    input  wire [31:0]          cg_tol_q16_16,
    input  wire [CTX_AW-1:0]    cg_prim_base,
    ...
    input  wire                 cg_busy,
    input  wire                 cg_prim_start,
    input  wire [3:0]           cg_prim_id,
    output reg                  cg_prim_accept,
    output reg                  cg_prim_done,
    ...
    localparam [2:0] S_CLEAR  = 3'd3;
    localparam [2:0] S_ISSUE  = 3'd4;
    localparam [2:0] S_WAIT   = 3'd5;
    localparam [2:0] S_RETIRE = 3'd6;
    localparam [2:0] S_ERROR  = 3'd7;
    ...
    wire [CTX_AW-1:0] cg_prim_id_ext = cg_prim_id;
    wire [CTX_AW-1:0] cg_pc = cg_prim_base + cg_prim_id_ext;
    wire cg_pc_ok = (cg_prim_id <= 4'd6);
            ...
            if (dma_error) begin
                ...
                case (state)
                    ...
                    S_FETCH: begin
                        ...
                        end else if (!normal_pc_ok) begin
                            error <= 1'b1;
                            error_code <= ERR_PC_RANGE;
                            state <= S_ERROR;
                        end else begin
                    ...
                    S_RETIRE: begin
                        if (cg_service) begin
                            ...
                            pc <= return_pc;
                            state <= S_FETCH;
                        end else if (ctx_word[59:56] == UOP_CTRL) begin
