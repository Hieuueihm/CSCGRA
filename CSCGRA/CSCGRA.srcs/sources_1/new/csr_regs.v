module csr_regs #(
    ...
    output reg  [15:0]          cg_maxiter,
    output reg  [31:0]          cg_tol_q16_16,
    output reg  [CTX_AW-1:0]    cg_prim_base,
            ...
            if (wr_fire) begin
                ...
                if (ctx_addr_hit_wr) begin
                    ...
                    case (s_axi_awaddr)
                        ...
                        A_CG_MAXITER: cg_maxiter <= s_axi_wdata[15:0];
                        A_CG_TOL:     cg_tol_q16_16 <= s_axi_wdata;
                        A_CG_PRIM:    cg_prim_base <= s_axi_wdata[CTX_AW-1:0];
            ...
            if (rd_fire) begin
                ...
                if (ctx_addr_hit_rd) begin
                    ...
                    case (s_axi_araddr)
                        ...
                        A_CG_MAXITER: s_axi_rdata <= {16'd0, cg_maxiter};
                        A_CG_TOL: s_axi_rdata <= cg_tol_q16_16;
                        A_CG_PRIM: s_axi_rdata <= {{(32-CTX_AW){1'b0}}, cg_prim_base};
