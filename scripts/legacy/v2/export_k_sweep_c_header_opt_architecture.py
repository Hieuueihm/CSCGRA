...
vh = (root / 'tests/run1/k_sweep_golden_mu3.vh').read_text()
out = root / 'sdk_app/src/cscgra_k_sweep_golden.h'
...
lines.append('#define KSGOLD_SOURCE_TAG "CSCGRA_opt_architecture_opt2/tests/run1/k_sweep_golden_mu3.vh"')
