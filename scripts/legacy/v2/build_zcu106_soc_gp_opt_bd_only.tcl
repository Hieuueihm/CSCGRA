...
if {[info exists ::env(CSCGRA_SOC_RUN_DIR)]} {
  ...
  set run_dir [file join $root_dir runs bd_zcu106_soc_gp_opt_bd_only]
}
...
create_project cscgra_zcu106_soc_gp_opt $proj_dir -part xczu7ev-ffvc1156-2-e -force
...
validate_bd_design
save_bd_design
generate_target all [get_files [file join $proj_dir cscgra_zcu106_soc_gp_opt.srcs sources_1 bd cscgra_soc_bd cscgra_soc_bd.bd]]
make_wrapper -files [get_files [file join $proj_dir cscgra_zcu106_soc_gp_opt.srcs sources_1 bd cscgra_soc_bd cscgra_soc_bd.bd]] -top
set wrapper_file [file join $proj_dir cscgra_zcu106_soc_gp_opt.gen sources_1 bd cscgra_soc_bd hdl cscgra_soc_bd_wrapper.v]
if {![file exists $wrapper_file]} { set wrapper_file [file join $proj_dir cscgra_zcu106_soc_gp_opt.srcs sources_1 bd cscgra_soc_bd hdl cscgra_soc_bd_wrapper.v] }
