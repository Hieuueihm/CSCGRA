...
if {[info exists ::env(CSCGRA_SOC_RUN_DIR)]} {
  ...
  set run_dir [file join $root_dir CSCGRA_noisy_mu runs bd_zcu106_soc_noisy_mu_current]
}
...
create_project cscgra_zcu106_soc_noisy_mu $proj_dir -part xczu7ev-ffvc1156-2-e -force
set_property target_language Verilog [current_project]
foreach bp {xilinx.com:zcu106:part0:2.6 xilinx.com:zcu106:part0:1.2 xilinx.com:zcu106:part0:1.1 xilinx.com:zcu106:part0:1.0} { if {[catch {set_property board_part $bp [current_project]}] == 0} { break } }
set rtl_dir [file join $root_dir CSCGRA_noisy_mu CSCGRA.srcs sources_1 new]
...
validate_bd_design
save_bd_design
generate_target all [get_files [file join $proj_dir cscgra_zcu106_soc_noisy_mu.srcs sources_1 bd cscgra_soc_bd cscgra_soc_bd.bd]]
make_wrapper -files [get_files [file join $proj_dir cscgra_zcu106_soc_noisy_mu.srcs sources_1 bd cscgra_soc_bd cscgra_soc_bd.bd]] -top
set wrapper_file [file join $proj_dir cscgra_zcu106_soc_noisy_mu.gen sources_1 bd cscgra_soc_bd hdl cscgra_soc_bd_wrapper.v]
if {![file exists $wrapper_file]} { set wrapper_file [file join $proj_dir cscgra_zcu106_soc_noisy_mu.srcs sources_1 bd cscgra_soc_bd hdl cscgra_soc_bd_wrapper.v] }
...
if {[llength [info commands write_hw_platform]] > 0} { write_hw_platform -fixed -include_bit -force -file [file join $artifact_dir cscgra_zcu106_soc_noisy_mu.xsa] } else { write_bitstream -force [file join $artifact_dir cscgra_zcu106_soc_noisy_mu.bit]; write_hwdef -force -file [file join $artifact_dir cscgra_zcu106_soc_noisy_mu.hdf] }
write_checkpoint -force [file join $artifact_dir cscgra_zcu106_soc_noisy_mu_routed.dcp]
close_project
