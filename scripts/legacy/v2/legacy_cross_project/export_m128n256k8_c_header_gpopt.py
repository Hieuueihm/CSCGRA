...
vh=(root/'CSCGRA_gp_opt/tests/run1/m128n256k8_golden_mu3.vh').read_text()
out=root/'CSCGRA_gp_opt/sdk_app/src/cscgra_m128n256k8_golden.h'
...
lines.append('#define KSGOLD_SOURCE_TAG "CSCGRA_gp_opt/tests/run1/m128n256k8_golden_mu3.vh"')
