if {$argc != 3} {
    error "Usage: run_ooc.tcl <v1|v2> <top> <log-dir>"
}

set rtl_version [lindex $argv 0]
set top_name [lindex $argv 1]
set log_dir [file normalize [lindex $argv 2]]
if {$rtl_version ni {v1 v2}} {
    error "Unsupported RTL version: $rtl_version"
}
...
report_utilization -file [file join $log_dir "${top_name}_utilization.rpt"] \
    -hierarchical
report_timing_summary -file [file join $log_dir "${top_name}_timing.rpt"] \
