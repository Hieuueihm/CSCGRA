...
vh=(root/'CSCGRA_noisy_mu/tests/k_sweep_golden_mu3.vh').read_text()
out=root/'CSCGRA_noisy_mu/sdk_app/src/cscgra_k_sweep_golden.h'
...
lines.append('#define KSGOLD_SOURCE_TAG "CSCGRA_noisy_mu/tests/k_sweep_golden_mu3.vh"')
