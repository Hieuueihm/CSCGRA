`timescale 1ns/1ps
module tb_factor_range_template_program #(
    ...
    integer revision,pcount,tcount,vcount,ccount,limit_value,expected_load_fault,expected_fault,expected_detail,expected_status,cancel_mode,start_rows_value,start_cols_value;
    ...
    initial begin
        ...
        for(c=0;c<ncases;c=c+1) begin
            ...
            rc=$fscanf(fd,"%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d",revision,pcount,tcount,vcount,ccount,records,services,limit_value,expected_load_fault,expected_fault,expected_detail,expected_status,cancel_mode,start_rows_value,start_cols_value);
            if(rc!=15)$fatal(1,"case header");
            start_rows=start_rows_value;start_cols=start_cols_value;
