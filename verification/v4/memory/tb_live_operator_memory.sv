...
module tb_live_operator_memory;
    reg  clk = '0;
    reg  rst = '0;
    reg  cancel = '0;
    ...
    task feed_test;
        begin
            ...
            for(fdense=0;fdense<2;fdense=fdense+1) begin
                ...
                for(frfour=0;frfour<2;frfour=frfour+1) for(ftrans=0;ftrans<2;ftrans=ftrans+1) begin
                    ...
                    for(fs=0;fs<(frfour ? 8 : 1);fs=fs+1) begin
                        f_req_out=fo;f_req_red=fr;f_req_step=fs;feed_one;
                    end
                end
            end
            ...
            fdense=0;frfour=0;ftrans=0;fo=0;fr=0;fs=0;feed_one;
    ...
    live_operator_memory dut (
        ...
        .b_job(b_job),
        .b_fmt(b_fmt),
        .mat_valid(feed_active ? f_mat_valid : mat_valid),
        .mat_ready(mat_ready),
        ...
        .mat_rsp_ready(feed_active ? f_mat_rsp_ready : mat_rsp_ready),
