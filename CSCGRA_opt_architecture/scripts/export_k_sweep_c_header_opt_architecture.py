...
vh=(root/'CSCGRA_opt_architecture/tests/run1/k_sweep_golden_mu3.vh').read_text()
out=root/'CSCGRA_opt_architecture/sdk_app/src/cscgra_k_sweep_golden.h'
...
lines.append('#define KSGOLD_SOURCE_TAG "CSCGRA_opt_architecture/tests/run1/k_sweep_golden_mu3.vh"')
