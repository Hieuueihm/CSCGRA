...
vh=(root/'CSCGRA_gp_opt/tests/run1/k_sweep_golden_mu3.vh').read_text()
out=root/'CSCGRA_gp_opt/sdk_app/src/cscgra_k_sweep_golden.h'
...
lines.append('#define KSGOLD_SOURCE_TAG "CSCGRA_gp_opt/tests/run1/k_sweep_golden_mu3.vh"')
