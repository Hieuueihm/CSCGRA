module addrgen #(
    ...
    input  wire [7:0]               lane_mask_lit,
    input  wire [3:0]               lane_mask_mode,
    input  wire [3:0]               addr_dim,
    input  wire [2:0]               spm_a_vec,
    input  wire [2:0]               spm_b_vec,
    input  wire [2:0]               spm_w_vec,
    input  wire [2:0]               spm_addr_mode,
    input  wire [9:0]               abs_addr,
    input  wire [3:0]               lfsr_ctrl,
