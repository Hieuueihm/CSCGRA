...
set proj_dir [file join $script_dir vivado_zcu106_soc]
set report_dir [file join $script_dir reports]
set artifact_dir [file join $script_dir artifacts]
file mkdir $proj_dir
file mkdir $report_dir
file mkdir $artifact_dir
create_project cscgra_zcu106_soc_current $proj_dir -part xczu7ev-ffvc1156-2-e -force
...
validate_bd_design
save_bd_design
generate_target all [get_files [file join $proj_dir cscgra_zcu106_soc_current.srcs sources_1 bd cscgra_soc_bd cscgra_soc_bd.bd]]
make_wrapper -files [get_files [file join $proj_dir cscgra_zcu106_soc_current.srcs sources_1 bd cscgra_soc_bd cscgra_soc_bd.bd]] -top
add_files -norecurse [file join $proj_dir cscgra_zcu106_soc_current.gen sources_1 bd cscgra_soc_bd hdl cscgra_soc_bd_wrapper.v]
