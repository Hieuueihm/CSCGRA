...
MEAS_SNR_DB = 20
MU_SHIFT = 3
ALG_SEEDS = {"OMP": 87, "GOMP": 13, "CoSaMP": 77, "SP": 48, "IHT": 101, "HTP": 20, "GP": 132, "MP": 140}
...
def main():
    ...
    csv_path=OUT/"noisy_lfsr_24bit_per_algorithm_seed_k8_gp_linesearch.csv"
    ...
    json_path=OUT/"noisy_lfsr_24bit_per_algorithm_seed_k8_gp_linesearch.json"
